...
get.outputs = function(n=100, subnetSize.X=rep(10,2), subnetSize.E=rep(10,2),
                       sparsity.B=5, sparsity.Theta=5, K=5, seed.vec=1:13, filename=NULL){
  ...
  out.mat = lapply(26+seed.vec, loopfun)
  if(is.null(filename)){
    filename = paste0("estmis_n",n,"p",p,"q",q,"_3.Rda")
  }
  save(out.mat, file=filename)
}

##### Generate data
# get.outputs(n = 100, subnetSize.X = c(30, 30), subnetSize.E = c(15, 15), nrep=10)
# get.outputs(n = 100, subnetSize.X = c(15, 15), subnetSize.E = c(30, 30), nrep=10)
...
get.outputs(n = 200, subnetSize.X = c(100, 100), subnetSize.E = c(100, 100),
            sparsity.B=30, sparsity.Theta=30, filename="estmis_n200p200q200modelB_3.Rda")
get.outputs(n = 100, subnetSize.X = c(100, 100), subnetSize.E = c(100, 100),
            sparsity.B=30, sparsity.Theta=30, filename="estmis_n100p200q200modelB_3.Rda")
