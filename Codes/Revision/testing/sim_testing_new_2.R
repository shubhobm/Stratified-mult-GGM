...
get.outputs = function(n=100, subnetSize.X=rep(10,2), subnetSize.E=rep(10,2),
  ...
  out.mat = lapply(30+seed.vec, loopfun)
  if(is.null(filename)){
    filename = paste0("testnew_n",n,"p",p,"q",q,"_2.Rda")
  }
...
get.outputs(n = 100, subnetSize.X = c(100, 100), subnetSize.E = c(100, 100),
            sparsity.B=30, sparsity.Theta=30, filename="testnew_n100p200q200modelB_2.Rda")
get.outputs(n = 200, subnetSize.X = c(100, 100), subnetSize.E = c(100, 100),
            sparsity.B=30, sparsity.Theta=30, filename="testnew_n200p200q200modelB_2.Rda")
get.outputs(n = 300, subnetSize.X = c(100, 100), subnetSize.E = c(100, 100),
            sparsity.B=30, sparsity.Theta=30, filename="testnew_n300p200q200modelB_2.Rda")
