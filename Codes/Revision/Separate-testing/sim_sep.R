...
get.outputs = function(n=100, subnetSize.X=rep(10,2), subnetSize.E=rep(10,2),
                       sparsity.B=5, sparsity.Theta=5, K=5, seed.vec=1:5, filename=NULL){
...
#             sparsity.B=30, sparsity.Theta=30, filename="estsep_n200p200q200modelB.Rda")
# get.outputs(n = 100, subnetSize.X = c(100, 100), subnetSize.E = c(100, 100),
#             sparsity.B=30, sparsity.Theta=30, filename="estsep_n100p200q200modelB.Rda")
