...
get.outputs = function(n=100, subnetSize.X=rep(10,2), subnetSize.E=rep(10,2),
  ...
  if(is.null(filename)){
    filename = paste0("testsizenew_n",n,"p",p,"q",q,"_1.Rda")
  }
...
get.outputs(n = 100, subnetSize.X = c(100, 100), subnetSize.E = c(100, 100),
            sparsity.B=30, sparsity.Theta=30, filename="testsizenew_n100p200q200modelB_1.Rda")
# get.outputs(n = 200, subnetSize.X = c(100, 100), subnetSize.E = c(100, 100),
#             sparsity.B=30, sparsity.Theta=30, filename="testsizenew_n200p200q200modelB_1.Rda")
get.outputs(n = 300, subnetSize.X = c(100, 100), subnetSize.E = c(100, 100),
            sparsity.B=30, sparsity.Theta=30,
            filename="testsizenew_n300p200q200modelB_1.Rda")
