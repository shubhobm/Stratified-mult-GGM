...
\vspace{.5cm}
\noindent\textbf{Keywords}: Data integration; Gaussian Graphical Models; Neighborhood selection; Group lasso; hypothesis testing; multiple testing; false discovery rate
