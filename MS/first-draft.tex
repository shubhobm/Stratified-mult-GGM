...
\noindent{\bf(T3)} Define \textbf{$\widehat \bfS^k := (\bfY^k - \bfX^k \widehat \bfB^k)(\bfY^k - \bfX^k \widehat \bfB^k)^T/n, k \in \cI_K$}. Then for all $j \in \cI_q$
%
$$
\left\| \frac{1}{n} \widehat \bfS^k \bfT_{0,j}^k \right\|_\infty \leq {\colrbf tbd}
$$ 
...
%
\item $\widehat \bfS^k$ satisfies the following bound
%
$$
\left\| \frac{1}{n} \widehat \bfS^k \bfT_{0,j}^k \right\|_\infty \leq {\colrbf tbd}
$$
