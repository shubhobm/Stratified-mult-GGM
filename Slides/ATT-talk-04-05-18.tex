...
\item $\Omega_x = \{ \Omega_x^1, \ldots, \Omega_x^K \}, \Omega_y = \{ \Omega_y^1, \ldots, \Omega_y^K \},
\cB = \{ \bfB^1, \ldots, \bfB^K \}$;
\end{itemize}
...
\item Recover precision matrices as MLE over the restricted supports: %% break
%
\begin{align*}
